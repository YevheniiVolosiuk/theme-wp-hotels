      ...
      function q(e) {
        e.disabled ||
          (!e.calendarContainer.classList.contains('qs-hidden') &&
            !e.alwaysShow &&
            (w(!0, e), e.calendarContainer.classList.add('qs-hidden'), e.onHide(e)));
      }
      function S(e) {
        ...
        if (n) {
          ...
          e
            ? (a.classList.add('qs-hidden'),
              ...
              (r.value = ''))
            : (a.classList.remove('qs-hidden'), i.classList.add('qs-blur'), s.classList.add('qs-blur'), r.focus());
        }
      }
      function M(e, t, n, a) {
        ...
        if (13 === (e.which || e.keyCode) || 'click' === e.type)
          a ? p(null, n, i, a) : r || t.classList.contains('qs-disabled') || p(null, n, i, a);
        ...
        if (null == t)
          (e[u()] = void 0),
            i
              ? ((i[u()] = void 0),
                n
                  ? ((r && !a) || (!r && !i.dateSelected)) && ((e.minDate = void 0), (i.minDate = void 0))
                  : ((r && !i.dateSelected) || (!r && !a)) && ((e.maxDate = void 0), (i.maxDate = void 0)))
              : (e[h()] = void 0);
        else {
          ...
          i
            ? (((r && n && l > (a || o)) ||
              ...
              (e[u()] = l),
              (i[u()] = l),
              ((n && ((r && !a) || (!r && !i.dateSelected))) || (!n && ((r && !i.dateSelected) || (!r && !a)))) &&
                ((e[h()] = l), (i[h()] = l)))
            : (((n && l > (a || o)) || (!n && l < (a || s))) && v(), (e[h()] = l));
        }
        return i && d(i), d(e), e;
      }
      function O() {
        ...
        var n = (function (e, t) {
          ...
          var l = (function (e, t) {
              ...
              if (u) {
                function b(e) {
                  throw (
                    '"dateSelected" in options is ' + (e ? 'less' : 'greater') + ' than "' + (e || 'max') + 'Date".'
                  );
                }
                d > u && b('min'), l < u && b();
              }
