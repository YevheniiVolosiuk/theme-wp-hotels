...
<main class="front-page">
  <section class="front-page__hero section-hero">
    ...
    <div class="section-about__container">
      <div class="section-about__top">
        <div class="section-about__info">
          <a href="tel:380322975020" class="section-about__phone">+38 032 297 50 20</a>
          <address class="section-about__address">8 Lystopadovoho Chynu,Lviv</address>
        </div>
